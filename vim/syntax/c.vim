...
if !exists("c_no_names")
  ...
  "syn match       c89Identifier     display "\<\w\+\>\s\+\*\?\<\w\+\>"
...
if exists("c_no_comment_fold")
  ...
  syn region      cComment          keepend matchgroup=cCommentDelim start="/\*" end="\*/" contains=cCommentString,cCommentGroup,cCommentStartError,@Spell fold
endif
