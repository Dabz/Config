...
if &t_Co > 255
    ...
    hi Error           ctermfg=89  ctermbg=16
    ...
    hi Search          ctermfg=231 ctermbg=59

    " marks column
    hi SignColumn      ctermfg=148 ctermbg=235
    hi SpecialChar     ctermfg=197               cterm=bold
    hi SpecialComment  ctermfg=59                cterm=bold
    "hi Special         ctermfg=81  ctermbg=232
    hi Special         ctermfg=81
    hi SpecialKey      ctermfg=102

    hi Statement       ctermfg=197               cterm=bold
    "hi StatusLine      ctermfg=238 ctermbg=59
    hi StatusLine                  ctermbg=59
    hi StatusLineNC    ctermfg=16  ctermbg=244
    ...
    hi VertSplit       ctermfg=244 ctermbg=16    cterm=bold
