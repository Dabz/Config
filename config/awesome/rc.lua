...
terminal = "xterm -bg black -fg white -fs 14"
...
dnicon.image = image(home .. "/.config/awesome/icons/up.png")
upicon.image = image(home .. "/.config/awesome/icons/down.png")
-- Initialize widget
...
fsicon.image = image(home .. "/.config/awesome/icons/disk.png")
-- Initialize widget
fswidget = widget({ type = "textbox" })

-- Create a gmailwidget (inbox status)
gmailicon = widget({ type = "imagebox" })
gmailicon.image = image(home .. "/.config/awesome/icons/mail.png")
-- Initialize widget
...
wifiicon.image = image(home .. "/.config/awesome/icons/wifi.png")
-- Initialize widget
...
clockicon.image = image(home .. "/.config/awesome/icons/time.png")
...
os.execute('knetworkmanager --nograb  --fork&')
